...
const tposition = [
  {
    value: "Medial and Lateral Malleolus",
    name: "tposition",
    classname: "exam1",
  },
  { value: "ATF Ligament", name: "tposition", classname: "exam1" },
  { value: "Syndesmosis", name: "tposition", classname: "scar" },
  { value: "Achilles", name: "tposition", classname: "scar" },
  { value: "Posterior Tibia", name: "tposition", classname: "scar" },
  { value: "Peroneals", name: "tposition", classname: "exam1" },
...
const other5 = [{ name: "anteriorreason" }];
const reason3 = [
...
const examreset3 = [{ name: "anteriorreason" }];
const exam1reset3 = [{ name: "anterior" }];
...
//Thompson test
const other6 = [{ classname: "Thompsonreason" }];
const reason4 = [
  { value: "surgery", name: "Thompsonreason", classname: "scar" },
  { value: "Complaint of pain", name: "Thompsonreason", classname: "exam1" },
  { value: "Non-cooperation", name: "Thompsonreason", classname: "exam1" },
  {
    value: "Not wish to perform",
    name: "Thompsonreason",
    classname: "exam1",
  },
  { value: "Brace", name: "Thompsonreason", classname: "scar" },
];
const notperform4 = [
  { value: "Not-Performed", name: "Thompson", classname: "exam" },
];
const examreset4 = [{ name: "Thompsonreason" }];
const exam1reset4 = [{ name: "Thompson" }];
const negativepositive01 = [
  { value: "Negative", name: "Thompson", classname: "scar" },
];
const negativepositive11 = [
  { value: "Positive", name: "Thompson", classname: "scar" },
];
//strength
...
//sensation
const other8 = [{ classname: "sensationreason" }];
const reason6 = [
...
const examreset6 = [{ name: "sensationreason" }];
const exam1reset6 = [{ name: "sensation" }];
...
const leftanklelabel = [{ name: "Left Ankle" }];
const rightanklelabel = [{ name: "Right Ankle" }];

export const Leftankle = () => (
  <Ankle
    pagelabel={leftanklelabel}
    aspect={aspect}
    scar={scar}
    scarreset={scarreset}
...
export const RightAnkle = () => (
  <Ankle
    pagelabel={rightanklelabel}
    aspect={aspect}
    scar={scar}
    scarreset={scarreset}
    appearance={appearance}
